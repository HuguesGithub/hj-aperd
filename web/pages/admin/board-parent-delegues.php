<div class="wrap">
  <h1 class="wp-heading-inline">Parents Délégués</h1>
    ...
    <div class="col-8">
      <div class="card-body" style="padding-top: 20px;">
        <form action="#" method="post" id="post-filters" class="md-form">
          ...
          <table class="table table-striped table-bordered table-hover table-sm" aria-describedby="Liste des Parents Délégués">
            <thead>
              <tr>
                <td id="cb" class="manage-column column-cb check-column"><input id="cb-select-all-1" type="checkbox"></td>
                <th scope="col" id="nomParent" class="manage-column">Parent</th>
                <th scope="col" id="labelDivision" class="manage-column">Division</th>
                <th scope="col" id="actionParentDelegue" class="manage-column column-actions">Actions</th>
              </tr>
            </thead>
